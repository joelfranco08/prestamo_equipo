...
@section('content')
<div class="card shadow-sm max-width-600 mx-auto" style="max-width: 700px;">
        ...
        <form action="{{ route('equipos.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="codigo" value="{{ old('codigo') }}" class="form-control @error('codigo') is-invalid @enderror" placeholder="Ej: INV-PORT-001">
                    @error('codigo') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>

                <div class="col-md-6 mb-3">
                    <label class="form-label font-weight-bold">Nombre / Elemento</label>
                    <input type="text" name="nombre" value="{{ old('nombre') }}" class="form-control @error('nombre') is-invalid @enderror" placeholder="Ej: Portátil HP ProBook">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="marca" value="{{ old('marca') }}" class="form-control @error('marca') is-invalid @enderror" placeholder="Ej: Lenovo, Epson, Sony">
            ...
            <button type="submit" class="btn btn-success w-100">Guardar Equipo en Inventario</button>
        </form>
    </div>
</div>
@endsection
